...
func init() {
	registry.RegisterSolution(2024, 4, func() utils.Solution {
		testInput1, testInput2 := utils.GetInput(2024, 4)
		return utils.Solution{
			Day:   4,
			Test1: day4part1(testInput1) == 18,
			Test2: day4part2(testInput2) == 9,
		}
	})
}
