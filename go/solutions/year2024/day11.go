...
func init() {
	registry.RegisterSolution(2024, 11, func() utils.Solution {
		input1, input2 := utils.GetInput(2024, 11)
		return utils.Solution{
			Day:   11,
			Test1: day11part1(input1) == 55312,
			Test2: day11part2(input2) == 65601038650482,
		}
	})
}

// day11part1 - Part 1 of this puzzle is to get the total number of stones after 25 "blinks"
...
// day11part2 - Same as part 1, but requiring 75 "blinks"
